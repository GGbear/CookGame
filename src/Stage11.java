...
public class Stage11 extends JFrame
{
	...
	private String fileName = new String("s11-1.dat");
	...
	public Stage11(final JFrame inputFrame,final StageSelect stageSelect) 
	{
		o = new OpeningMusic("11.wav");
		o.start();
		...
		//設定需要用到的背景
		img0 = new ImageIcon("ghosthouse.jpg"); 
		img1 = new ImageIcon("black.jpg"); 
		img2 = new ImageIcon("nightkitchen.jpg"); 
		img3 = new ImageIcon("11meal.jpg"); 
		        ...
		        if(clickTimes>=15)
		       	{
		       		try 			//讓台詞顯現在text內
			        {
			        	...
			        	{
			        		if(StageSelect.currentStage<=11)
			        			StageSelect.currentStage=12;
			        		stageSelect.Stagebutton[11].setVisible(true);
			        		finish();
			        	}
			        }
			        catch(EOFException e)
