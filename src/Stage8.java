...
public class Stage8 extends JFrame
{
	...
	private String fileName = new String("s8-1.dat");
	...
	public Stage8(final JFrame inputFrame,final StageSelect stageSelect) 
	{
		o = new OpeningMusic("08.wav");
		o.start();
		        ...
		        if(clickTimes>=14)
		       	{
		       		try 			//讓台詞顯現在text內
			        {
			        	...
			        	{
			        		if(StageSelect.currentStage<=8)
			        			StageSelect.currentStage=9;
			        		stageSelect.Stagebutton[8].setVisible(true);
			        		finish();
			        	}
			        }
			        catch(EOFException e)
